...
public class Home extends Activity {
    ...
    public void Terms(View arg0){
		...
		Intent intent = new Intent(Home.this, AltTravel.class);
		startActivity(intent);

	}
	public void Predictor(View arg0){
		Intent intent = new Intent(Home.this, Predictor.class);
		startActivity(intent);

	}
	public void Userguide(View arg0){
		Intent intent = new Intent(Home.this, Userguide.class);
		startActivity(intent);
